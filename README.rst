...
.. code-block:: bash
    ...
    cd eraldoenergy
    celery -A eraldoenergy.taskapp worker -l info
...
To run the tests, enter the eraldoenergy/tests directory and run the following commands::
